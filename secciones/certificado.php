...
$sql = "SELECT alumnos.nombre, alumnos.apellidos, cursos.nombre_curso as nombre_curso FROM alumnos, cursos WHERE alumnos.id=:idalumno AND cursos.id=:idcurso";
...
agregarImagen($pdf, "../src/assets/images/certificado_.png", 0, 0);
